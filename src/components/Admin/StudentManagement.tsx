...
import { Users, Search, Filter, Eye, Ban, CheckCircle, AlertTriangle, Clock } from 'lucide-react';
                  ...
                  <tr key={student.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(student)}`}>
                        ...
                        <span className="ml-1">
                          {student.isBlocked ? 'Blocked' : student.status || 'Offline'}
                        </span>
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        {student.tabSwitchCount > 0 ? (
                          ...
                          <span className="text-green-600 text-sm">Clean record</span>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(selectedStudent)}`}>
                        {selectedStudent.isBlocked ? 'Blocked' : selectedStudent.status || 'Offline'}
                      </span>
                    </div>
                  </div>
