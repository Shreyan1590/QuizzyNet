...
const FacultyDashboard: React.FC = () => {
  ...
  const calculateStudentPerformance = (results: any[]) => {
    ...
    const topPerformers = results
      ...
      .map((result) => ({
        name:
          result.studentName || result.studentEmail?.split("@")[0] || "Student",
      ...
      <div className="ml-64 pt-16">
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Faculty ID: {userData?.facultyId} • Department:{" "}
              {userData?.department}
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-xs text-green-600">
                    {studentPerformance.activeStudents} active
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {studentPerformance.averagePerformance}%
                  </p>
